...
| Pull Gong-native call briefs, highlights, outlines, or CRM entity briefs. | blocked | queued for Phase 13k | Not part of the current Postgres client-ready surface. Use transcript evidence and cached metadata until endpoint contracts are reviewed. |
