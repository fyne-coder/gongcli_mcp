...
The `v0.6.3` examples require the matching Git tag workflow to have published
...
```bash
docker run --rm ghcr.io/fyne-coder/gongcli_mcp/gongmcp:v0.6.3 --list-tool-presets
```
