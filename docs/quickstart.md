...
```bash
docker run --rm ghcr.io/fyne-coder/gongcli_mcp/gongctl:v0.6.1 version
```

The `v0.6.1` examples require the matching Git tag workflow to have published
...
- `ghcr.io/fyne-coder/gongcli_mcp/gongctl:v0.6.1`
- `ghcr.io/fyne-coder/gongcli_mcp/gongmcp:v0.6.1`
- `gongctl:local`
- `gongctl:mcp-local`
...
```bash
docker run --rm ghcr.io/fyne-coder/gongcli_mcp/gongmcp:v0.6.1 --list-tool-presets
```
