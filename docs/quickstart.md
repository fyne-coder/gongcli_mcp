...
The `v0.4.4` examples require the matching Git tag workflow to have published
...
- `ghcr.io/fyne-coder/gongcli_mcp/gongctl:v0.4.4`
- `ghcr.io/fyne-coder/gongcli_mcp/gongmcp:v0.4.4`
- `gongctl:local`
- `gongctl:mcp-local`
...
```bash
docker run --rm ghcr.io/fyne-coder/gongcli_mcp/gongmcp:v0.4.4 --list-tool-presets
```
