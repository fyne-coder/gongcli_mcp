...
```bash
docker run --rm ghcr.io/fyne-coder/gongcli_mcp/gongctl:v0.5.3 version
```

The `v0.5.3` examples require the matching Git tag workflow to have published
...
- `ghcr.io/fyne-coder/gongcli_mcp/gongctl:v0.5.3`
- `ghcr.io/fyne-coder/gongcli_mcp/gongmcp:v0.5.3`
- `gongctl:local`
- `gongctl:mcp-local`
...
```bash
docker run --rm ghcr.io/fyne-coder/gongcli_mcp/gongmcp:v0.5.3 --list-tool-presets
```
