...
```bash
docker run --rm ghcr.io/fyne-coder/gongcli_mcp/gongctl:v0.5.4 version
```

The `v0.5.4` examples require the matching Git tag workflow to have published
...
- `ghcr.io/fyne-coder/gongcli_mcp/gongmcp:v0.5.4`
- `gongctl:local`
- `gongctl:mcp-local`
...
```bash
docker run --rm ghcr.io/fyne-coder/gongcli_mcp/gongmcp:v0.5.4 --list-tool-presets
```
