...
The `v0.4.2` examples require the matching Git tag workflow to have published
...
- `ghcr.io/fyne-coder/gongcli_mcp/gongctl:v0.4.2`
- `ghcr.io/fyne-coder/gongcli_mcp/gongmcp:v0.4.2`
- `gongctl:local`
- `gongctl:mcp-local`
...
```bash
docker run --rm ghcr.io/fyne-coder/gongcli_mcp/gongmcp:v0.4.2 --list-tool-presets
```
