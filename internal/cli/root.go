...
func (a *app) usage() {
  ...
  gongctl cache purge --config retention-policy.yaml [--dry-run|--confirm]
  ...
  gongctl doctor mcp-gateway --url URL [--issuer URL] [--required-scope gongmcp/read] [--expect-dcr] [--token-env ENV] [--origin ORIGIN] [--timeout DURATION]
