...
func TestMCPPostgresReaderSQLBusinessWorkbench(t *testing.T) {
	...
	for _, want := range []string{
		...
		`GRANT EXECUTE ON FUNCTION public.gongmcp_business_analysis_calls_sanitized(text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, boolean, integer) TO "gongmcp_business_workbench_reader";`,
		`GRANT EXECUTE ON FUNCTION public.gongmcp_business_analysis_evidence_sanitized(text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, boolean, integer) TO "gongmcp_business_workbench_reader";`,
