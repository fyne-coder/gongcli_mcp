...
func ExpandToolPresetFacadeRoutedTools(name string) ([]string, error) {
	...
	case "business-workbench", "analyst-facade", "facade-analyst":
		...
		return append(tools, internalRoutedToolListAIHighlights, internalRoutedToolQuestionAnswer, internalRoutedToolCallDrilldown, internalRoutedToolThemeIntelReport), nil
