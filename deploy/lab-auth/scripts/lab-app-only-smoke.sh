...
GONGMCP_INTERNAL_PARTICIPANT_DOMAINS="$(remote_env GONGMCP_INTERNAL_PARTICIPANT_DOMAINS)"
...
LAB_GONGMCP_INTERNAL_PARTICIPANT_DOMAINS="$GONGMCP_INTERNAL_PARTICIPANT_DOMAINS" \
