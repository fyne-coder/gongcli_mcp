...
LAB_GONGMCP_INTERNAL_PARTICIPANT_DOMAINS="${LAB_GONGMCP_INTERNAL_PARTICIPANT_DOMAINS:-${GONGMCP_INTERNAL_PARTICIPANT_DOMAINS:-}}"
LAB_GONGMCP_HTTP_TOOL_TIMEOUT="${LAB_GONGMCP_HTTP_TOOL_TIMEOUT:-${GONGMCP_HTTP_TOOL_TIMEOUT:-}}"
...
set_env_value "$tmpdir/.env" GONGMCP_INTERNAL_PARTICIPANT_DOMAINS "$LAB_GONGMCP_INTERNAL_PARTICIPANT_DOMAINS"
set_env_value "$tmpdir/.env" GONGMCP_HTTP_TOOL_TIMEOUT "$LAB_GONGMCP_HTTP_TOOL_TIMEOUT"
