...
ARG COMMIT=unknown
ARG DATE=unknown
LABEL org.opencontainers.image.source="https://github.com/fyne-coder/gongcli_mcp" \
	org.opencontainers.image.description="Unofficial local-first Gong CLI and read-only SQLite/Postgres MCP adapter" \
